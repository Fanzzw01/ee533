...
// Tag/address widths
`define NETFPGA_TEST_BLOCK_ADDR_WIDTH  16
`define NETFPGA_TEST_REG_ADDR_WIDTH    7
...
`define NETFPGA_TEST_BLOCK_ADDR  16'h0008
`define IN_ARB_BLOCK_ADDR        17'h00012
...
`define NETFPGA_TEST_IP_CORE_WDATA_DIN   7'h0
`define NETFPGA_TEST_IP_CORE_WEA         7'h1
`define NETFPGA_TEST_IP_CORE_ADDR        7'h2
`define NETFPGA_TEST_IP_CORE_RDATA_DOUT  7'h3
