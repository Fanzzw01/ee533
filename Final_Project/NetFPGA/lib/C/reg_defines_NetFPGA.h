 ...
 * Project: NetFPGA (NetFPGA)
 * Description: NetFPGA test project
 *
 ********************************************************/

#ifndef _REG_DEFINES_NETFPGA_
#define _REG_DEFINES_NETFPGA_
...
#define DEVICE_PROJ_DIR    "NetFPGA"
#define DEVICE_PROJ_NAME   "NetFPGA"
#define DEVICE_PROJ_DESC   "NetFPGA test project"
...
#define NETFPGA_TEST_BASE_ADDR  0x2001000
#define IN_ARB_BASE_ADDR        0x2001200
...
// Name: NetFPGA_test (NETFPGA_TEST)
// Description: Registers for NetFPGA_test
// File: projects/NetFPGA/include/NetFPGA_test.xml
#define NETFPGA_TEST_IP_CORE_WDATA_DIN_REG    0x2001000
#define NETFPGA_TEST_IP_CORE_WEA_REG          0x2001004
#define NETFPGA_TEST_IP_CORE_ADDR_REG         0x2001008
#define NETFPGA_TEST_IP_CORE_RDATA_DOUT_REG   0x200100c

// Name: in_arb (IN_ARB)
// Description: Round-robin input arbiter
// File: lib/verilog/core/input_arbiter/rr_input_arbiter/xml/rr_input_arbiter.xml
#define IN_ARB_NUM_PKTS_SENT_REG        0x2001200
#define IN_ARB_LAST_PKT_WORD_0_HI_REG   0x2001204
#define IN_ARB_LAST_PKT_WORD_0_LO_REG   0x2001208
#define IN_ARB_LAST_PKT_CTRL_0_REG      0x200120c
#define IN_ARB_LAST_PKT_WORD_1_HI_REG   0x2001210
#define IN_ARB_LAST_PKT_WORD_1_LO_REG   0x2001214
#define IN_ARB_LAST_PKT_CTRL_1_REG      0x2001218
#define IN_ARB_STATE_REG                0x200121c
