...
def NETFPGA_TEST_IP_CORE_WDATA_DIN_REG ():  
    return 0x2001000

def NETFPGA_TEST_IP_CORE_WEA_REG ():        
    return 0x2001004

def NETFPGA_TEST_IP_CORE_ADDR_REG ():       
    return 0x2001008

def NETFPGA_TEST_IP_CORE_RDATA_DOUT_REG (): 
    return 0x200100c
...
__main__.nf_regmap.update({
    ...
    0x2001000 : "NETFPGA_TEST_IP_CORE_WDATA_DIN_REG",
    0x2001004 : "NETFPGA_TEST_IP_CORE_WEA_REG",
    0x2001008 : "NETFPGA_TEST_IP_CORE_ADDR_REG",
    0x200100c : "NETFPGA_TEST_IP_CORE_RDATA_DOUT_REG",
