...
@EXPORT = qw(
                ...
                NETFPGA_TEST_IP_CORE_WDATA_DIN_REG
                NETFPGA_TEST_IP_CORE_WEA_REG
                NETFPGA_TEST_IP_CORE_ADDR_REG
                NETFPGA_TEST_IP_CORE_RDATA_DOUT_REG
...
sub DEVICE_PROJ_DIR ()  { "NetFPGA"; }
sub DEVICE_PROJ_NAME () { "NetFPGA"; }
sub DEVICE_PROJ_DESC () { "NetFPGA test project"; }
...
sub NETFPGA_TEST_BASE_ADDR ()   { 0x2001000; }
...
sub NETFPGA_TEST_IP_CORE_WDATA_DIN_REG ()    { 0x2001000;}
sub NETFPGA_TEST_IP_CORE_WEA_REG ()          { 0x2001004;}
sub NETFPGA_TEST_IP_CORE_ADDR_REG ()         { 0x2001008;}
sub NETFPGA_TEST_IP_CORE_RDATA_DOUT_REG ()   { 0x200100c;}
