...
def PASSTHROUGH_CMD_REG_REG ():  
    return 0x2001200

def PASSTHROUGH_FLAG_REG_REG (): 
    return 0x2001204

def PASSTHROUGH_HW_REG0_REG ():  
    return 0x2001208

def PASSTHROUGH_ADDR_REG_REG (): 
    return 0x200120c
...
__main__.nf_regmap.update({
    ...
    0x2001200 : "PASSTHROUGH_CMD_REG_REG",
    0x2001204 : "PASSTHROUGH_FLAG_REG_REG",
    0x2001208 : "PASSTHROUGH_HW_REG0_REG",
    0x200120c : "PASSTHROUGH_ADDR_REG_REG",
