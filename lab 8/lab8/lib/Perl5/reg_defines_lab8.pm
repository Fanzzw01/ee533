...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                PASSTHROUGH_CMD_REG_REG
                PASSTHROUGH_FLAG_REG_REG
                PASSTHROUGH_HW_REG0_REG
                PASSTHROUGH_ADDR_REG_REG
...
sub PASSTHROUGH_BASE_ADDR ()   { 0x2001200; }
...
# Description: Registers for programming I-memory and D-memory
# File: projects/lab8/include/passthrough.xml
sub PASSTHROUGH_CMD_REG_REG ()    { 0x2001200;}
sub PASSTHROUGH_FLAG_REG_REG ()   { 0x2001204;}
sub PASSTHROUGH_HW_REG0_REG ()    { 0x2001208;}
sub PASSTHROUGH_ADDR_REG_REG ()   { 0x200120c;}
