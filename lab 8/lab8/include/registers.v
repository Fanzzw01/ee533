...
`define PASSTHROUGH_BLOCK_ADDR_WIDTH  16
`define PASSTHROUGH_REG_ADDR_WIDTH    7
...
`define PASSTHROUGH_BLOCK_ADDR  16'h0009
...
`define PASSTHROUGH_CMD_REG   7'h0
`define PASSTHROUGH_FLAG_REG  7'h1
`define PASSTHROUGH_HW_REG0   7'h2
`define PASSTHROUGH_ADDR_REG  7'h3
